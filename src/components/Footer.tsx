...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[#050505] text-[#FFFFFF] pt-16 md:pt-32 pb-8 md:pb-16">
      <div className="container mx-auto max-w-[1800px] px-4 md:px-12 lg:px-20">
        
        {/* Upper Footer Area */}
        <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <nav className="order-2">
            <ul className="flex items-center gap-4 md:gap-12 text-[#FFFFFF] font-medium text-sm md:text-lg">
          ...
          <div className="flex items-center gap-4 md:gap-8 order-3">
            {socialLinks.map((social) => (
              ...
              >
                <i className={`${social.icon} text-lg md:text-2xl`}></i>
              </a>
            ))}
          </div>
        </div>
        ...
        {/* Lower Footer Area */}
        <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-3 md:gap-4 text-gray-400 text-xs md:text-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-xs uppercase font-sans order-2">
